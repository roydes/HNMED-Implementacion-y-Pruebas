...
format long
    ...
    for hora=1:HORAS    %Cada hora representa una problema de optimización diferente     
       ...
       %display(['HORA ',num2str(hora)]);
        ...
        %Se busca al mejor individuo de la población inicial usando
        %criterios de Deb
        best=X(1,:);%Para iniciar la busqueda del mejor, el best se inicializa con el primer individuo de la población
        for i=2:NP
